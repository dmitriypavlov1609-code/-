...
class ConfigTests(unittest.TestCase):
    ...
    def test_load_settings_parses_admin_ids(self) -> None:
        ...
        os.environ["COMETAPI_API_KEY"] = "comet"
        os.environ["ADMIN_IDS"] = "1, 2,3"
        settings = load_settings()
        self.assertEqual(settings.admin_ids, {1, 2, 3})
        self.assertEqual(settings.llm_api_key, "comet")
        self.assertEqual(settings.llm_api_url, "https://api.cometapi.com/v1/chat/completions")
